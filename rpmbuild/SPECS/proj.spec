...
%changelog
* Tue Feb 26 2013 Quinn Hart <qjhart@ucdavis.edu> - 4.7.0-2_1
- Added GOES Satellite data support

* Tue Nov 08 2011 Mathieu Baudier <mbaudier@argeo.org> - 4.7.0-2_0
- Rebuild on Scientific Linux 6.1

* Mon Apr 11 2011 Mathieu Baudier <mbaudier@argeo.org> - 4.7.0-2
- Mass rebuild for EL 5.6
- Update NAD to 1.5
- proj requires proj-epsg (see http://www.osgeo.org/pipermail/el/2010-November/000161.html)
- make it pass rpmlint without warnings

* Sun Dec 07 2009 Peter Hopfgartner <peter.hopfgartner@r3-gis.com> - 4.7.0-1
